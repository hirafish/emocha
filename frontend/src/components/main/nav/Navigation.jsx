        ...
        <div className={"xl:block sm:flex-2 w-64 bg-gray-200 dark:bg-gray-800 "+navTailwind}>
            <div className="p-4 flex justify-end">
                <span onClick={()=>{handleOpenCloseNav()}} className="xl:hidden inline-block text-gray-700 hover:text-gray-900 align-bottom">
                    <span className="block h-6 w-6 p-1 rounded-full hover:bg-gray-400 dark:hover:bg-gray-950 flex justify-center items-center">
                        {/* <img src="/navIcon/close.svg" className="dark:text-white" /> */}
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" className="h-5 w-5 dark:text-gray-100 dark:hover:text-white">

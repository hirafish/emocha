        ...
        <div className="message mb-4">
            ...
            <div className="relative group w-fit">
                ...
                <div className="flex-1 px-2 w-fit">
                    <div className={slangsList[0]?"inline-block bg-gray-300 dark:bg-gray-800 dark:border-gray-800 rounded-full p-2 px-6 text-gray-700 ml-6 border-2 border-gray-300 hover:border-white dark:hover:border-gray-700":"inline-block bg-gray-300 rounded-full p-2 px-6 text-gray-700 ml-6 border-2 border-gray-300"}>

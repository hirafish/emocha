...
const ChatArea = () => {
  ...
  useEffect(() => {
    ...
    onValue(
      ...
      (snapshot) => {
        ...
        if (messages) {
          const latestKey = Object.keys(messages).reduce((a, b) =>
            a > b ? a : b
          );
          setLatestMessage(messages[latestKey]);
        } else {
  ...
  if (!latestMessage) return <p>Loading...</p>;
        ...
        <div className="message mb-4 flex">
          ...
          <div className="flex-1 px-2">
            <div className="inline-block rounded-full p-2 px-6">
              ...
              <img
                src="https://i.giphy.com/DPvq36SD00MihIDc00.webp"

...
const Setup = () => {
  ...
  const sendUserData = async (postData) => {
    try {
      ...
      console.log("ユーザー設定が保存できませんでした", error);
    }
  };
  ...
  return (
    <div className="main flex-1 flex flex-col min-h-0 dark:bg-gray-900">
      <header className="sticky top-0 w-full bg-white shadow flex justify-between dark:bg-gray-900 dark:shadow-gray-100">
        ...
        <div className="my-4 mr-6 xl:mr-10 flex justify-center items-center">
          ...
          <form className="max-w-sm mx-auto">
            <select
              value={language}
              onChange={handleChangeSetupPageLanguage}
              id="underline_select"
              className="block py-1 px-1 w-full text-sm text-black bg-transparent border-0 border-b-2 border-gray-200  dark:text-white dark:border-gray-700 focus:outline-none focus:ring-0 focus:border-gray-200 peer"
            >
      ...
      <div className="lg:block heading flex-2">
        <h1 className="text-xl py-1 xl:text-3xl xl:text-gray-700 xl:mb-4  mx-8 mt-8 dark:text-white">
          {language === "English" ? "Setup" : "ユーザー設定"}
        </h1>
      </div>
        ...
        <div className="mx-10">
          <div className="container mb-10">
            ...
            <div className="md:w-3/5 md:pl-12 my-8">
              ...
              >
                {language === "English" ? "User name" : "ユーザー名"}
              </label>
              <input
                type="text"
                id="userName"
            ...
            <div className="md:w-3/5 md:pl-12 my-8">
              <label
                ...
                className="block mb-2 text-sm font-medium text-gray-900 dark:text-white"
              >
                {language === "English" ? "Social account" : "SNSアカウント"}
              </label>
              <input
                type="url"
                id="snsUrl"
          ...
          <div className="md:pl-12 container flex justify-center md:justify-start items-center mx-auto my-6">
            <button
              ...
              type="button"
              className="inline-flex items-center justify-center w-36 px-5 py-3 text-sm font-medium tracking-wide text-white transition-colors duration-200 bg-blue-500 rounded-md hover:bg-blue-700 focus:ring-2 focus:ring-offset-2 focus:ring-blue-700 focus:shadow-outline focus:outline-none"
            >

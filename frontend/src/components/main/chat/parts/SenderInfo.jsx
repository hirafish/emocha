    ...
    return (
        <div className={senderInfo.isShow?tailwindShowSenderInfo:tailwindNotShowSenderInfo}>
            <div className="flex items-center justify-end">
                <span className="p-2">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" onClick={handleClickClose} className="w-4 h-4 cursor-pointer dark:text-white">
            ...
            <div className="flex-1 px-4 py-2 flex flex-col justify-evenly items-center">
                <div className="flex flex-col justify-center items-center">
                    ...
                    <span className="pt-2 font-medium text-xl dark:text-white">{senderInfo.data.name}</span>
                </div>
                <div className="pl-5 pr-4 w-full">
                    <div className="flex items-center">
                        <span>
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" className="w-4 h-4 dark:text-white">
                                {/* <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--> */}
                        ...
                        <span className="mx-3 dark:text-white">{senderInfo.data.language}</span>
                    </div>
                    {senderInfo.data.snsUrl?
                        <div className="flex items-center pt-2">
                            <a target="_blank" href={senderInfo.data.snsUrl} className=" cursor-pointer">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="w-4 h-4 dark:text-white">
                                    {/* <!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--> */}
                            ...
                            <a target="_blank" href={senderInfo.data.snsUrl} className="w-full mx-3 overflow-auto cursor-pointer dark:text-white">{senderInfo.data.snsUrl}</a>
                        </div>
                    :""}
                </div>
            </div>
